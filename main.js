...
async function fetchReport(data) {
  const messages = [
    {
      role: "system",
      content:
        "You are a trading guru. Given data on share prices over the past 3 days, write a report of no more than 100 words describing the stocks performance and recommending whether to buy, hold or sell. You use the example provided between ### to set the tone and style of your response",
    },
    {
      role: "user",
      content: `${data}
  ...
  try {
    const response = await fetch(
      "https://openai-api.austinjuwon.workers.dev/",
      {
        method: "POST",
        headers: {
